...
class ServiceNodeIndex extends React.Component {
    static contextTypes = {
            ...
            columns: [{
                ...
                events: {
                    "click .console": (e, value, row, index)=> {
                        this.props.history.pushState(null, `/app/${this.props.params.appId}/node/${row.nodeId}`)
                    },
        ...
        return (
            <div id="nodes">
                ...
                <div id="node_toolbar">
                    ...
                    <Link to={`app/${this.props.params.appId}/node/new`} className="btn btn-primary ml5">注册</Link>
                    <span className="ml10">
                        网络类型：
...
export default HistoryMixin(ServiceNodeIndex)
